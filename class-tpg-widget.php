...
if (basename($_SERVER['SCRIPT_FILENAME']) == 'class-tpg-widget.php') { die ("Please do not access this file directly. Thanks!"); }
class Class_tpg_widget extends WP_Widget {
	public function __construct() {
		$widget_options = array(
			'classname' => 'Class_tpg_widget',
			'description' => __('Widget to show the most transparenzgesetz.at banner', 'lmm'));
		$control_options = array();
		parent::__construct( __CLASS__, '<span>' . __('Transparenzgesetz.at', 'lmm') . '</span>', $widget_options, $control_options);
	}
